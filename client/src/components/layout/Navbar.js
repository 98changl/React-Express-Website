    ...
    return (
        <div className='row sticky-top'>
            <nav className='navbar navbar-expand-lg navbar-dark bg-dark'>
                ...
                <button className='navbar-toggler me-4' type='button' data-bs-toggle='collapse' data-bs-target='#navbarContent' aria-controls='navbarContent' aria-expanded='false' aria-label='Toggle navigation'>
